...
class owner_register extends Controller{
    ...
    public function register(){
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            // }
            // // else{
            // //     if($this->ownerModel->findOwnerByMobileNo($data['mobile'])){
            ...
            //     $data['confirm-Password_err'] = 'Confirm password is required';
            // }elseif($data['confirm-Password'] != $data['password']){
            //     $data['confirm-Password_err'] = 'Paswords must match';
            // }
            ...
            empty($data['mobile_err']) && empty($data['password_err']) && 
            empty($data['confirm-Password_err']) ){

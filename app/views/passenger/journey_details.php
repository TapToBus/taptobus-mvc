    ...
    <div class="main">
        <div class="form">
            <form action="" method="">
                ...
                <div class="from">
                    <label for="from">From:<sup>*</sup></label> <br>
                    <select name="from">
                    ...
                    <span><?php //echo 'From error'?></span>
                </div>

                <div class="to">
                    <label for="to">To:<sup>*</sup></label> <br>
                    <select name="to">
                        <option value="default">Select starting point</option>
                        <option value="galle">Galle</option>
                        <option value="hambantota">Hambantota</option>
                    ...
                    <span><?php //echo 'To error'?></span>
                </div>

                <div class="date">
                    <label for="date">Date:<sup>*</sup></label> <br>
                    <input type="date" name="date" placeholder="Select date"> <br>
                    <span><?php //echo 'Date error'?></span>
                </div>

                <div class="count">
                    <label for="count">No of passengers:<sup>*</sup></label> <br>
                    <select name="count">
                    ...
                    <span><?php //echo 'Count error'?></span>
                </div>

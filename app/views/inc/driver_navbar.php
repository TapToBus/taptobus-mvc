...
<div class="side-menu">
    ...
    <a href="<?php echo URLROOT; ?>/driver_schedule/view_schedule"><i class="fa-solid fa-calendar-days"></i><span>Schedule</span></a>
    <a href="<?php echo URLROOT; ?>/driver_leaverequests/add_leaverequests"><i class="fa-solid fa-newspaper"></i><span>Leave Requests</span></a>
    <a href="<?php echo URLROOT; ?>/driver_notifications/view_notifications"><i class="fa-solid fa-bell"></i><span>Notifications</span></a>

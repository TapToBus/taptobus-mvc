...
<div class="side-menu">
    ...
    <a href="<?php echo URLROOT; ?>/conductor_incomerecords/view_incomerecords"><i class="fa-solid fa-bus"></i><span>Income Records</span></a>
    <a href="<?php echo URLROOT; ?>/conductor_schedule/view_schedule"><i class="fa-solid fa-user"></i><span>Schedule</span></a>
    <a href="<?php echo URLROOT; ?>/conductor_leaverequests/view_leaverequests"><i class="fa-solid fa-newspaper"></i><span>Leave Requests</span></a>

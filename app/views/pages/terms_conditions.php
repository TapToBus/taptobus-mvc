...
<?php require APPROOT . '/views/inc/components/pages_navbar.php' ?>

<div class="content">
    <h1>Terms & Conditions</h1>

    <h2><u>Seat Reservation</u></h2>
    <ul>
    ...
    <table>
        <tr>
            <td class="a">Time condition</td>
            <td class="b">Before 48 hours<br>(+2 daye)</td>
            <td class="b">Before 24 hours<br>(+1 day)</td>
            <td class="b">After 24 hours<br>(-1 day)</td>
        </tr>
        <tr>
            <td class="a">Refunding percentage<br>from the ticket fee</td>
            <td class="b">75%</td>
            <td class="b">50%</td>
            <td class="b">0%</td>
        </tr>
    ...
    <h2><u>Registration of Bus Owners</u></h2>
    <ul>
